...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { address: @charity.address, description: @charity.description, name: @charity.name, phone: @charity.phone } }, as: :json
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { address: @charity.address, description: @charity.description, name: @charity.name, phone: @charity.phone } }, as: :json
    assert_response 200
  end
